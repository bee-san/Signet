...
def build_production_runtime(
    ...
    *,
    ...
    def health_prover(component: Literal["mcp", "web"]) -> Callable[[str], str]:
        return lambda challenge: production_health_proof(
            health_secret,
    ...
    mcp = (
        assemble_mcp_runtime(
            ...
            health_prover=health_prover("mcp"),
    ...
    if web is not None:
        ...
        web.state.signet_health_identity = health_identity
        web.state.signet_health_prover = health_prover("web")
